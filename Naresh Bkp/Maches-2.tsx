...
const OrganizerMatchScheduler = () => {
  ...
  const [scheduledMatches] = useState([
    {
      ...
      date: "2025-10-15",
      time: "14:00",
      registrationEnd: "2025-10-15T12:00",
      status: "scheduled",
      players: 16,
      maxPlayers: 32,
      entryFee: 50,
      ...
      lastBallLastPocket: "yes",
      ballInHand: "yes",
      fewRules: "Standard 9-ball rules apply. No jump shots allowed.",
      moreDetails: "This is a premier tournament with professional referees."
    },
    {
      id: 2,
      ...
      date: "2025-10-20",
      time: "18:00",
      registrationEnd: "2025-10-20T16:00",
      status: "open",
      players: 8,
      maxPlayers: 16,
      entryFee: 30,
      venue: "Mumbai Billiards Hall",
      lastBallLastPocket: "no",
      ballInHand: "yes",
      fewRules: "Call your shots. Safety shots allowed.",
      moreDetails: "Evening tournament with dinner included."
    }
  ]);

  const [previousMatches] = useState([
    {
      id: 3,
    ...
    {
      id: 4,
      name: "Monsoon 8-Ball Championship",
      gameType: "8-ball",
      date: "2025-08-20",
      time: "15:00",
      status: "completed",
      ...
      maxPlayers: 24,
      entryFee: 40,
      venue: "Kolkata Billiards Center",
      winner: "Priya Sharma",
      prize: "$300"
    }
  ]);
  ...
  const lastBallOptions = [
    { value: 'yes', label: 'Yes' },
    { value: 'no', label: 'No' }
  ];

  const ballInHandOptions = [
    { value: 'yes', label: 'Yes' },
    { value: 'no', label: 'No' }
  ];
                  ...
                  <div className="p-8 space-y-8">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-2">
                            Last Ball Last Pocket
                          </label>
                          <select
                            value={matchForm.lastBallLastPocket}
                            onChange={(e) => handleInputChange('lastBallLastPocket', e.target.value)}
                            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          >
                            {lastBallOptions.map(option => (
                        ...
                        <div>
                          ...
                          <select
                            value={matchForm.ballInHand}
                            onChange={(e) => handleInputChange('ballInHand', e.target.value)}
                            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          >
                            {ballInHandOptions.map(option => (
                              <option key={option.value} value={option.value}>
                                {option.label}
                              </option>
                            ))}
              ...
              <div className="p-6 space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">{selectedMatch.players}/{selectedMatch.maxPlayers}</p>
                  </div>
                </div>

                {selectedMatch.lastBallLastPocket && (
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <span className="text-sm font-medium text-gray-500">Last Ball Last Pocket</span>
                      <p className="text-gray-900">{selectedMatch.lastBallLastPocket === 'yes' ? 'Yes' : 'No'}</p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-gray-500">Ball in Hand</span>
                      <p className="text-gray-900">{selectedMatch.ballInHand === 'yes' ? 'Yes' : 'No'}</p>
                    </div>
                  </div>
                )}
